...
<body id="home" class="bg animated fadeIn fo-all" style="overflow : hidden !important">
    <audio autoplay>
                ...
                <div class="row justify-content-center py-3">
                    <div class="px-3">
                        <a href="javascript:delay('sub.php')">
                            <button class="btn-custom animated bounceInLeft fo ">
                                <div class="d-flex justify-content-center">
                                    <div style="padding: 10px;"><img src="img/compass-n.png" width="60"></div>
                                    <div class="m-auto"><?php echo $btnmainNorth ?></div>
                                </div>
                            </button>
                        </a>
                    </div>
                    <div class="px-3">
                        <a href="#">
                            <button class="btn-custom animated bounceInLeft fo ">
                                <div class="d-flex justify-content-center">
                                    <div style="padding: 10px;"><img src="img/compass-s.png" width="60"></div>
                                    <div class="m-auto"><?php echo $btnmainSouth ?></div>
                                </div>
                            </button>
                        </a>
                    </div>
                    <div class="px-3">
                        <a href="#">
                            <button class="btn-custom animated bounceInLeft fo ">
                                <div class="d-flex justify-content-center">
                                    <div style="padding: 10px;"><img src="img/compass-e.png" width="60"></div>
                                    <div class="m-auto"><?php echo $btnmainEast ?></div>
                                </div>
                            </button>
                        </a>
                    </div>
                    <div class="px-3">
                        <a href="#">
                            <button class="btn-custom animated bounceInLeft fo ">
                                <div class="d-flex justify-content-center">
                                    <div style="padding: 10px;"><img src="img/compass-w.png" width="60"></div>
                                    <div class="m-auto"><?php echo $btnmainWest ?></div>
                                </div>
                            </button>
                        </a>
                    </div>
